...
const Counters = ({report, previousReport}) => {
  ...
  const details = {
    casConfirmes: 'Nombre de cas de COVID-19 confirmés par un test positif. <br />Ce chiffre est bien en deça du nombre probable de cas de COVID-19<br /> puisque la stratégie sanitaire actuelle est de ne tester que les cas les plus inquiétants.<br /> Un nouvel indicateur plus pertinent sera bientôt proposé.',
    gueris: 'Nombre de personnes ayant été hospitalisées pour COVID-19 <br />et de retour à domicile en raison de l’amélioration de leur état de santé',
    ...
    reanimation: ' Nombre de patients hospitalisés pour COVID-19<br /> et nécessitant une assistance respiratoire'
  }
